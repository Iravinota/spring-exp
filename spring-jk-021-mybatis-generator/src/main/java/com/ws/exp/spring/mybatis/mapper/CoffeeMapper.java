...
public interface CoffeeMapper {
    ...
    @Insert({
        ...
        "values (#{name,jdbcType=VARCHAR}, #{price,jdbcType=BIGINT,typeHandler=com.ws.exp.spring.mybatis.handler.MoneyTypeHandler}, ",
    ...
    @ResultMap("com.ws.exp.spring.mybatis.mapper.CoffeeMapper.BaseResultMap")
    ...
    @Update({
        ...
        "set NAME = #{name,jdbcType=VARCHAR},",
          "PRICE = #{price,jdbcType=BIGINT,typeHandler=com.ws.exp.spring.mybatis.handler.MoneyTypeHandler},",
